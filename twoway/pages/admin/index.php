    ...
    <div class="main-content">
        ...
        <div class="dashboard-grid">
            <div class="card">
                ...
                <p>Pesquise e gerencie membros do chat interno.</p>
                <a href="../search_users/index.php" class="btn-acao">Ir para Busca</a>
            </div>
            ...
            <div class="card">
                ...
                <a href="../logs/logs.php" class="btn-acao">Ver Logs</a>
            </div>

            <div class="card">
                <h3>Buscar Grupos</h3>
                <p>Pesquie e Gerencie grupos de membros do seu chat.</p>
                <a href="../search_groups/" class="btn-acao">Buscar Grupos</a>
            </div>

            <div class="card">
                <h3>Criar Grupos</h3>
                <p>Crie e Gerencie grupos de membros do seu chat.</p>
                <a href="../create_groups/" class="btn-acao">Criar Grupos</a>
            </div>
        ...
        <!-- <div class="dashboard-grid">
            <div class="card">
                <h3>Buscar Grupos</h3>
                <p>Pesquie e Gerencie grupos de membros do seu chat.</p>
                <a href="#" class="btn-acao">Buscar Grupos</a>
            </div>

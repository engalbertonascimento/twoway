...
<head>
    ...
    <title>Chat</title>
    <link rel="stylesheet" href="../../styles/chat/styletest.css">
    <link rel="stylesheet" href="../../styles/chat/style.css">
    <link rel="stylesheet" href="../../styles/search_users/styles.css">
    <script type="module" src="https://cdn.jsdelivr.net/npm/emoji-picke0r-element@1"></script>     
</head>
<body>
  <div class="sidebar1"> <br> <br>
    <button class="botao-universal">
    <img src="../../images/engrenagem.png" alt="Configuração">
    </button>
  </div>
      <div id="sidebar">
